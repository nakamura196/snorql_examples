...
var Snorqldef = {
	...
	vars: {
		...
		default_query: "SELECT DISTINCT * WHERE {\n\tbind (<http://data.archives-nationales.culture.gouv.fr/record/003500> as ?s)\n\t?s ?v ?o\n}\nLIMIT 100",
