...
var Snorqldef = {
	...
	vars: {
		...
		_endpoint: "https://lila-erc.eu/sparql/lila_knowledge_base/sparql",
		...
		default_query: "SELECT DISTINCT * WHERE {\n\tbind (<http://lila-erc.eu/data/corpora/Lasla/id/corpus/VergiliusGeorgica> as ?s)\n\t?s ?v ?o\n}\nLIMIT 100",
